            ...
            VStack(alignment: .leading, spacing: 20) {
                ThemedSectionCard(title: "Observation") {
                    VStack(alignment: .leading, spacing: 14) {
                        ...
                        Toggle("Cloud answers via Qwen", isOn: $appState.cloudProcessingEnabled).tint(AppTheme.blue)
                ...
                ThemedSectionCard(title: "Qwen Cloud") {
                    VStack(spacing: 14) {
                ...
                ThemedSectionCard(title: "Web Search", subtitle: "Optional API keys in .env.local") {
                    ThemedInfoBanner(
                        text: "Default: DuckDuckGo (no key). Optional: TAVILY_API_KEY or BRAVE_SEARCH_API_KEY",
                        style: .info
                    )
                }
                ...
                ThemedSectionCard(title: "Privacy") {
                    VStack(alignment: .leading, spacing: 12) {
                        ThemedInfoBanner(text: "All memories stay on your Mac. Screenshots are never saved.", style: .success)
